...
Function MUDA_PJ(xArg1,xArg2,xArg3,xArg4,xArg5,xArg6)
   ...
   dispbegin()
   Do While (.T.)
      @ 25, 0 Say padc("Utilize as setas para posicionar a janela. ("+gcr+" aceita posiáÑo)",80)
      dispend()
      If (drvmouse)
...
Function MUDAFONTE(xArg1)
   ...
   ret_val:= ""
   If (cardtype() = 3 .AND. 25 < 49 .AND. file(xVar6))
      If (xArg1 == 0)
         SaveScreen()
         setmode(50,80)
         setmode(25,80)
...
Function CAIXAGAS(xArg1,xArg2,xArg3,xArg4,xArg5,xArg6,xArg7)
   ...
   If (IIf(xArg7 = Nil,.T.,xArg7) .AND. xArg3 >= 1 .AND. xArg4 < 25)
...
Function DBOX(xArg1,xArg2,xArg3,xArg4,xArg5,xArg6,xArg7,xArg8,xArg9,xArg10)
   ...
   Local xVar1,xVar2,xVar3,xVar4:= {},xVar5:= SetColor(),xVar6,xVar7,xVar8,xVar9:= 1,xVar10,xVar11:= .F.,xVar12,xVar13:= {},xVar14:= SaveScreen(0,0,25,79),xVar15,xVar16,xVar17,xVar18:= Row(),xVar19:= Col(),xVar20:= SetKey(-37,Nil),xVar21:= ;
   ...
   Else
      ...
      If (!epop_)
         ...
         EndIf
         xVar3:= IIf(xVar3 > 25,25,xVar3)
         If (xArg2 = Nil)
            xArg2:= Int((25+1-xVar3)/2)-1
         Else
            xArg2:= IIf(xArg2+xVar3 > 25,25-xVar3,xArg2)
         EndIf
      Else
         xArg3:= 0
         xVar2:= 78
         xVar3:= 0
      EndIf
      xVar12:= "drv"+alltrim(Str(Int(op_sis+(xArg2+25)*(xArg3+80)+25*((xArg2+25+xVar3)*(xArg3+80+xVar2)))))
      If (Type(xVar12) = "C")
      ...
      Do While (.T.)
         ...
         If (!epop_)
            Set Color To (tit_op)
            caixagas(mold,xArg2,xArg3,xArg2+xVar3,xArg3+xVar2+1)
         ...
         Else
            If (Len(l_msg) > 0)
               For ij:= 1 To Len(l_msg)
                  lin_:= xArg2+ij+xin
                  If (lin_ < xArg2+xVar3 .AND. lin_ < 25)
...
Function NOVAPOSI(xArg1,xArg2,xArg3,xArg4)
   ...
   Local xVar1
   xVar1:= "drv"+alltrim(Str(Int(op_sis*80+(xArg1+25)*(xArg2+80)+25*((xArg3+25)*(xArg4+80)))))
   If (Type(xVar1) = "C")
      d_1:= xArg3-xArg1
      d_2:= xArg4-xArg2
...
Function EDIMEMO(xArg1,xArg2,xArg3,xArg4,xArg5,xArg6)
   ...
   Local xVar1:= SetColor(),xVar2:= SaveScreen(0,0,25,79),xVar3:= .F.,xVar4,xVar5
   ...
   Do While (.T.)
      ...
      caixagas(mold,xArg3,xArg4,xArg5,xArg6,78)
            ...
            Else
               If (t_e_c_l_a = 27)
                  If (!memo_modif)
                     ret_val:= 27
                  Else
                     op_mf:= dbox("Sim|NÑo",Nil,Nil,.T.,Nil,"Sair ALTERAÄéO")
                     If (op_mf == 1)
                        ret_val:= 27
                     Else
                        ret_val:= 32
...
Static Function BARRACHEIA(xArg1,xArg2)
   ...
   If (drvpadrao == "1" .OR. drvpadrao == "2" .OR. drvpadrao == "3")
      xVar1:= Replicate("ˇ",iat(xArg1*(240/72),0))
   Else
      If (drvpadrao == "4")
         xVar1:= Replicate("ˇˇ¸",iat(xArg1*(180/72),0))
      Else
         If (drvpadrao == "5" .OR. drvpadrao == "6")
            xVar1:= Replicate("1",iat(300/72*xArg1,0))
         Else
...
Static Function BARRAVAZIA(xArg1)
   ...
   xVar1:= ""
   If (drvpadrao == "1" .OR. drvpadrao == "2" .OR. drvpadrao == "3")
      xVar1:= Replicate(Chr(0),iat(xArg1*(240/72),0))
   Else
      If (drvpadrao == "4")
         xVar1:= Replicate(Chr(0)+Chr(0)+Chr(0),iat(xArg1*(180/72),0))
      Else
         If (drvpadrao == "5" .OR. drvpadrao == "6")
            xVar1:= Replicate("0",iat(300/72*xArg1,0))
         Else
            If (drvpadrao == "7" .OR. drvpadrao == "8")
...
Function __XSAVESCR
   ...
   Static11:= {Row(),Col(),SaveScreen(0,0,25,MaxCol())}
   Return Nil
