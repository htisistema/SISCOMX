 ...
 * Generated C source code from <SACREP41.PRG>
 * Command: C:\xHarbour997\bin\harbour.exe C:\HELIO\SIACHB\SACREP41.PRG /q /oC:\helio\siachb\SACREP41.c /M /N -DxHB -DXHB_0990 -DXHB_0991 -DXHB_0992 -DXHB_0993 -DXHB_0994 -DXHB_09941 -DXHB_09950 -DXHB_09951a -DXHB_09951 -DXHB_09951b -DXHB_0996 -DXHB_09960 -DXHB_09961 -DXHB_09961B -DXHB_0997 -DXHB_09970 
 * Created: 2021.04.05 09:02:49 (Borland C++ 5.5.1)
 */
...
#define __PRG_SOURCE__ "SACREP41.PRG"
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_SACREP41 )
{ "SACREP41", {HB_FS_PUBLIC | HB_FS_LOCAL | HB_FS_FIRST}, {HB_FUNCNAME( SACREP41 )}, NULL },
...
HB_INIT_SYMBOLS_END( hb_vm_SymbolInit_SACREP41 )

#if defined(HB_PRAGMA_STARTUP)
   #pragma startup hb_vm_SymbolInit_SACREP41
      ...
      #pragma data_seg( "XIY" )
   #endif
   static HB_$INITSYM hb_vm_auto_SymbolInit_SACREP41 = hb_vm_SymbolInit_SACREP41;
   #pragma data_seg()
#endif
...
/* 00003 */ HB_P_BASELINE, 9, 0,	/* 9 */
	...
	'R', 'E', 'L', 'A', 'T', 'O', 'R', 'I', 'O', ' ', 'D', 'E', ' ', 'P', 'R', 'O', 'D', 'U', 'T', 'O', 'S', ' ', 'R', 'E', 'A', 'J', 'U', 'S', 'T', 'A', 'D', 'O', ' ', 'P', '/', 'D', 'A', 'T', 'A', ' ', 'D', 'E', ' ', 'R', 'E', 'A', 'J', 'U', 'S', 'T', 'E', 0, 
...
/* 00467 */ HB_P_LINEOFFSET, 25,	/* 34 */
	...
	HB_P_PUSHNIL,
	HB_P_PUSHSTRSHORT, 30,	/* 30 */
	'O', 'r', 'd', 'e', ' ', '[', '3', ']', 'C', 'o', 'd', 'i', 'g', 'o', ' ', '[', '4', ']', 'A', 'l', 'f', 'a', 'b', 'e', 't', 'i', 'c', 'a', ':', 0, 
	HB_P_DOSHORT, 1,
...
/* 00983 */ HB_P_LINEOFFSET, 45,	/* 54 */
	...
	'R', 'e', 'l', 'a', 't', 'o', 'r', 'i', 'o', ' ', 'd', 'e', ' ', 'P', 'r', 'o', 'd', 'u', 't', 'o', 's', ' ', 'c', 'o', 'm', ' ', 'R', 'E', 'A', 'J', 'U', 'S', 'T', 'E', ' ', 'p', '/', 'D', 'A', 'T', 'A', ' ', 'D', 'E', ' ', 'R', 'E', 'A', 'J', 'U', 'S', 'T', 'E', 0, 
	HB_P_POPVARIABLE, 5, 0,	/* MTIT */
/* 01044 */ HB_P_LINEOFFSET, 46,	/* 55 */
...
/* 01087 */ HB_P_LINEOFFSET, 47,	/* 56 */
	...
	'R', 0, 
	HB_P_FUNCTIONSHORT, 2,
	HB_P_JUMPTRUENEAR, 5,	/* 5 (abs: 01119) */
	HB_P_JUMP, 210, 252,	/* -814 (abs: 00302) */
/* 01119 */ HB_P_LINEOFFSET, 50,	/* 59 */
	HB_P_ZERO,
	HB_P_POPVARIABLE, 7, 0,	/* MPAG */
/* 01125 */ HB_P_LINEOFFSET, 51,	/* 60 */
	HB_P_FALSE,
	HB_P_PUSHSYMNEAR, 37,	/* EOF */
	HB_P_PUSHNIL,
	HB_P_FUNCTIONSHORT, 0,
	HB_P_JUMPTRUENEAR, 10,	/* 10 (abs: 01143) */
	HB_P_POP,
	HB_P_PUSHSYMNEAR, 34,	/* REPRO */
	HB_P_PUSHALIASEDFIELDNEAR, 41,	/* DATA_OK */
	HB_P_PUSHLOCALNEAR, 9,	/* MDATA2 */
	HB_P_LESSEQUAL,
	HB_P_JUMPFALSE, 83, 1,	/* 339 (abs: 01482) */
/* 01146 */ HB_P_LINEOFFSET, 52,	/* 61 */
	HB_P_PUSHVARIABLE, 7, 0,	/* MPAG */
	HB_P_ZERO,
	HB_P_EQUAL,
	HB_P_DUPLICATE,
	HB_P_JUMPTRUENEAR, 11,	/* 11 (abs: 01165) */
	...
	HB_P_GREATEREQUAL,
	HB_P_OR,
	HB_P_JUMPFALSE, 190, 0,	/* 190 (abs: 01355) */
/* 01168 */ HB_P_LINEOFFSET, 53,	/* 62 */
	HB_P_PUSHVARIABLE, 7, 0,	/* MPAG */
	HB_P_INC,
	HB_P_POPVARIABLE, 7, 0,	/* MPAG */
/* 01177 */ HB_P_LINEOFFSET, 54,	/* 63 */
	HB_P_PUSHVARIABLE, 7, 0,	/* MPAG */
	HB_P_ONE,
	HB_P_GREATER,
	HB_P_JUMPFALSENEAR, 9,	/* 9 (abs: 01193) */
/* 01186 */ HB_P_LINEOFFSET, 55,	/* 64 */
	HB_P_PUSHSYMNEAR, 43,	/* __EJECT */
	HB_P_PUSHNIL,
	HB_P_DOSHORT, 0,
/* 01193 */ HB_P_LINEOFFSET, 57,	/* 66 */
...
/* 01231 */ HB_P_LINEOFFSET, 59,	/* 68 */
	...
	'P', 'r', 'o', 'd', 'u', 't', 'o', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'P', 'r', 'e', 'c', 'o', ' ', 'R', 'e', 'a', 'j', '.', ' ', ' ', 'D', 'a', 't', 'a', ' ', ' ', 'O', 'K', ' ', ' ', 'O', 'p', 'e', 0, 
	HB_P_DOSHORT, 1,
/* 01331 */ HB_P_LINEOFFSET, 60,	/* 69 */
	HB_P_PUSHSYMNEAR, 19,	/* DEVPOS */
	HB_P_PUSHNIL,
	HB_P_PUSHSYMNEAR, 42,	/* PROW */
	HB_P_PUSHNIL,
...
/* 01376 */ HB_P_LINEOFFSET, 63,	/* 72 */
	...
	HB_P_PUSHNIL,
	HB_P_PUSHSYMNEAR, 34,	/* REPRO */
	HB_P_PUSHALIASEDFIELDNEAR, 48,	/* COD_PRO */
	HB_P_PUSHSTRSHORT, 2,	/* 2 */
	' ', 0, 
	HB_P_PLUS,
	HB_P_PUSHSYMNEAR, 34,	/* REPRO */
	HB_P_PUSHALIASEDFIELDNEAR, 49,	/* PRODUTO */
	HB_P_PLUS,
	HB_P_PUSHSTRSHORT, 7,	/* 7 */
	' ', ' ', ' ', ' ', ' ', ' ', 0, 
	HB_P_PLUS,
	...
	HB_P_PUSHNIL,
	HB_P_PUSHSYMNEAR, 34,	/* REPRO */
	HB_P_PUSHALIASEDFIELDNEAR, 51,	/* VALOR */
	...
	HB_P_PLUS,
	HB_P_PUSHSYMNEAR, 34,	/* REPRO */
	HB_P_PUSHALIASEDFIELDNEAR, 52,	/* OPE_OK */
	HB_P_PLUS,
	HB_P_DOSHORT, 1,
/* 01471 */ HB_P_LINEOFFSET, 64,	/* 73 */
	HB_P_PUSHSYMNEAR, 53,	/* DBSKIP */
	HB_P_PUSHNIL,
	HB_P_ONE,
	HB_P_DOSHORT, 1,
	HB_P_JUMP, 158, 254,	/* -354 (abs: 01125) */
/* 01482 */ HB_P_LINEOFFSET, 66,	/* 75 */
...
/* 01523 */ HB_P_LINEOFFSET, 67,	/* 76 */
	...
	'P', 'R', 'O', 'D', '_', 'R', 'E', 'A', 'J', '.', 'R', 'E', 'L', 0, 
	HB_P_DOSHORT, 1,
	HB_P_JUMP, 36, 251,	/* -1244 (abs: 00302) */
	HB_P_ENDPROC
/* 01550 */
   };
