*****************************
FUNCTION sacdbf(mop,marquivo,mdbf)
*****************************
...
mtip_term := 'S'
IF marquivo = NIL
        op_tela(10,10,13,80,' Verificando Arquivos DBFs, Aguarde um momento..... ')
ENDIF
f := 0
matriz:={}
AADD(matriz,{'scod_op','C',3,0,,,,,,1,})
AADD(matriz,{'snome','C',30,0})
AADD(matriz,{'stipo','C',1,0})
AADD(matriz,{'stipo_sis','C',1,0})
...
AADD(matriz,{'shora_ini','C',5,0})
AADD(matriz,{'shora_fim','C',5,0})
AADD(matriz,{'sult_e_c','D',8,0})
AADD(matriz,{'sh_i_c','C',5,0})
...
AADD(matriz,{'smensagem','C',150,0})
AADD(matriz,{'sambiente','C',5,0})
AADD(matriz,{'doc_apagar','C',1,0})
AADD(matriz,{'estoq_min','C',1,0})
AADD(matriz,{'estoq_med','N',5,0})
AADD(matriz,{'terminal','C',15,0})
AADD(matriz,{'data_acess','D',8,0})
AADD(matriz,{'hora_acess','C',8,0})
AADD(matriz,{'email','C',60,0})
AADD(matriz,{'dat_aniv','C',1,0})
AADD(matriz,{'ver_pocket','C',1,0})
AADD(matriz,{'endereco','C',40,0})
AADD(matriz,{'numero','C',6,0})
AADD(matriz,{'complemento','C',6,0})
AADD(matriz,{'bairro','C',20,0})
AADD(matriz,{'cidade','C',25,0})
AADD(matriz,{'uf','C',2,0})
AADD(matriz,{'fone','C',10,0})
AADD(matriz,{'cpf','C',11,0})
AADD(matriz,{'rg','C',15,0})
...
AADD(matriz,{'descri1','C',50,0})      // 09.09.2003
...
AADD(matriz,{'sittrib','C',4,0})       // 29.10.2002
...
AADD(matriz,{'doc_ent_a','C',12,0})
AADD(matriz,{'doc_ent','C',12,0})
...
AADD(matriz,{'pocket','C',1,0})
AADD(matriz,{'descri','C',50,0})
AADD(matriz,{'pr_venda2','N',12,4})
AADD(matriz,{'pr_venda3','N',12,4})
AADD(matriz,{'pr_venda4','N',12,4})
AADD(matriz,{'sld_neg','C',1,0})
AADD(matriz,{'descont','C',1,0})
AADD(matriz,{'cst_pis','C',2,0})
AADD(matriz,{'cst_conf','C',2,0})
AADD(matriz,{'chv_cript','C',350,0})
AADD(matriz,{'cfop_fora','C',5,0})
AADD(matriz,{'cfop_dent','C',5,0})
AADD(matriz,{'pis','N',7,2})
AADD(matriz,{'confis','N',7,2})
IF marquivo = 'sacmerc'
        RETURN matriz
ENDIF
IF ! FILE('SACMERC.DBF')
        DBCREATE('sacmerc',matriz,'DBFCDX')
ENDIF
**********************************************************************************************
DEVPOS(01,01);DEVOUT(STRZERO(f++,3)+'] Verificando o Arquivo -> SACCLI  ')
        matriz:={}
        AADD(matriz,{'empresa','C',3,0})
        AADD(matriz,{'cod_cli','C',5,0,,,,,,1,})
        ...
        AADD(matriz,{'pai','C',40,0})
        AADD(matriz,{'mae','C',40,0})
        AADD(matriz,{'end_cob','C',35,0})
        AADD(matriz,{'bairro_cob','C',20,0})
        AADD(matriz,{'cidade_cob','C',25,0})
        ...
        AADD(matriz,{'naturalidade','C',25,0})
        ...
        AADD(matriz,{'pocket','C',1,0})
        AADD(matriz,{'cod_profi','C',5,0})
        AADD(matriz,{'numero','C',6,0})
        AADD(matriz,{'complemento','C',10,0})
        AADD(matriz,{'data_bloq','D',8,0})
        AADD(matriz,{'obs_bloq','C',60,0})
        AADD(matriz,{'rota1','C',70,0})
        AADD(matriz,{'email1','C',70,0})
        AADD(matriz,{'email2','C',70,0})
        AADD(matriz,{'email3','C',70,0})
        AADD(matriz,{'lim_ant','N',10,2})
IF ! FILE('SACCLI.DBF')
        DBCREATE('SACCLI',matriz,'DBFCDX')
ENDIF
**********************************************************************************************
...
AADD(matriz,{'producao','C',6,0})       //27.04.2000
AADD(matriz,{'vlr_icm','N',15,2})
AADD(matriz,{'base_icm','N',15,2})
AADD(matriz,{'devolucao','C',1,0})
AADD(matriz,{'cod_presente','C',5,0})
AADD(matriz,{'norm_ele','C',1,0})
...
AADD(matriz,{'chnfe','C',55,0})
AADD(matriz,{'camnfe','C',90,0})
AADD(matriz,{'obs7','C',60,0})
AADD(matriz,{'obs8','C',60,0})
AADD(matriz,{'obs9','C',60,0})
AADD(matriz,{'obs10','C',60,0})
AADD(matriz,{'obs11','C',60,0})
AADD(matriz,{'obs12','C',60,0})
AADD(matriz,{'obs13','C',60,0})
AADD(matriz,{'obs14','C',60,0})
AADD(matriz,{'obs15','C',60,0})
AADD(matriz,{'obs16','C',60,0})
AADD(matriz,{'obs17','C',60,0})
AADD(matriz,{'obs18','C',60,0})
AADD(matriz,{'obs19','C',60,0})
AADD(matriz,{'obs20','C',60,0})
AADD(matriz,{'norm_ele','C',1,0})
//AADD(matriz,{'modelo','C',2,0})
DEVPOS(01,01);DEVOUT(STRZERO(f++,3)+'] Verificando o Arquivo -> SACTOT')
IF ! FILE('SACTOTNT.DBF')
        DBCREATE('SACTOTNT',matriz,'DBFCDX')
ENDIF
**********************************************************************************************
...
AADD(matriz,{'tef','C',1,0})
IF ! FILE('SACCARTA.DBF')
        DBCREATE('SACCARTA',matriz,'DBFCDX')
ENDIF
**********************************************************************************************
matriz:={}
AADD(matriz,{'empresa'  ,'C',3,0})
...
matriz:={}
AADD(matriz,{'cod_cli','C',5,0})
AADD(matriz,{'conjuge','C',40,0})
AADD(matriz,{'conj_nasc','D',8,0})
AADD(matriz,{'conj_cpf','C',11,0})
AADD(matriz,{'conj_rg','C',11,0})
AADD(matriz,{'conj_empre','C',20,0})
AADD(matriz,{'conj_cargo','C',15,0})
AADD(matriz,{'conj_salario','N',10,2})
AADD(matriz,{'conj_end','C',35,0})
AADD(matriz,{'conj_bairro','C',20,0})
AADD(matriz,{'conj_cidade','C',20,0})
AADD(matriz,{'conj_uf','C',2,0})
AADD(matriz,{'conj_cep','C',9,0})
AADD(matriz,{'conj_fone','C',14,0})
AADD(matriz,{'conj_obs','C',50,0})

AADD(matriz,{'avalista','C',40,0})
AADD(matriz,{'aval_sexo','C',1,0})
AADD(matriz,{'aval_civil','C',1,0})
AADD(matriz,{'aval_nasc','D',8,0})
AADD(matriz,{'aval_cpf','C',11,0})
AADD(matriz,{'aval_rg','C',11,0})
AADD(matriz,{'aval_empre','C',20,0})
AADD(matriz,{'aval_cargo','C',15,0})
AADD(matriz,{'aval_salario','N',10,2})
AADD(matriz,{'aval_end','C',35,0})
AADD(matriz,{'aval_bairro','C',20,0})
AADD(matriz,{'aval_cidade','C',20,0})
AADD(matriz,{'aval_uf','C',2,0})
AADD(matriz,{'aval_cep','C',9,0})
AADD(matriz,{'aval_fone','C',14,0})
AADD(matriz,{'aval_obs','C',50,0})
IF ! FILE('SACCLIAUX.DBF')
        DBCREATE('SACCLIAUX',matriz,'DBFCDX')
ENDIF
...
AADD(matriz,{'CHV_CRIPT','C',1000,0})
